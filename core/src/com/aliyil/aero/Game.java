...
import com.aliyil.aero.entity.InputCalculator;
import com.aliyil.aero.entity.Screen;
import com.aliyil.aero.screen.LoadingScreen;
...
public class Game extends ApplicationAdapter {
    ...
    public Game(IOsBridge osBridge) {
...
//                new Color(0.7f, 0.7f, 0.7f, 1f);
    ...
    @Override
    public void render() {
        Gdx.gl.glClearColor(sharedValues.bgColor.r, sharedValues.bgColor.g, sharedValues.bgColor.b, 1);
        ...
        while (currentIterator.hasNext()) {
            ...
            if (entity.canRender) {
                ...
                entity.shapeRender(shapeRenderer);
            }
        }
        currentIterator = null;
        shapeRenderer.end();
